...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER.split("254794286079,")
...
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? '亗『ＧＥＥ』亗's wife' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? '亗『ＧＥＥ』亗' : process.env.OWNER_NAME,
  ownernumber: process.env.OWNER_NUMBER === undefined ? '254794286079' : process.env.OWNER_NUMBER,
  sessionName:  process.env.SESSION_ID === undefined ? false : process.env.SESSION_ID,
  author:  process.env.PACK_INFO.split(";")[0] === undefined ? 'n͜͡önesence ×:亗『ＧＥＥ』亗' : process.env.PACK_INFO.split(";")[0],
  auto_read_status :  process.env.AUTO_READ_STATUS === undefined ? true : process.env.AUTO_READ_STATUS,
  packname:  process.env.PACK_INFO.split(";")[1] === undefined ? 'wife of 亗『ＧＥＥ』亗' : process.env.PACK_INFO.split(";")[1],	
  ...
  ALIVE_MESSAGE:  process.env.ALIVE_MESSAGE === undefined ? 'I am the wife of gee ,,,and you??' : process.env.ALIVE_MESSAGE,
  caption :process.env.CAPTION || "wife of 亗『ＧＥＥ』亗",
